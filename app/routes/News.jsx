...
const insta = ['https://www.instagram.com/p/BPab5RPAuOO/', 'https://www.instagram.com/p/BPfuiGnBFgr/', 'https://www.instagram.com/p/BPlioWmB1Re/']
...
const News = (props)=>{
	return (
			<Grid id="news-wrapper" fluid={true}>
					...
					{
						insta.map(inst => (
							<InstagramEmbed key={`${insta}`} url={`${inst}`} maxWidth={400} />
						))
					}
				</Col>
		</Grid>
